...
| Toolset | Core | Tools |
|---------|:----:|-------|
| `jira_issues` | Yes | `jira_get_issue`, `jira_get_rendered_html`, `jira_search`, `jira_get_project_issues`, `jira_create_issue`, `jira_batch_create_issues`, `jira_batch_get_changelogs`, `jira_update_issue`, `jira_assign_issue`, `jira_delete_issue`, `jira_move_issue` |
