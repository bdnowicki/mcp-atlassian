...
| `expand` | `string` | No | (Optional) fields to expand. Examples: 'transitions', 'changelog'. 'renderedFields' is accepted but has no effect here — use jira_get_rendered_html for rendered HTML. |
